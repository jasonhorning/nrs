...
<xsl:stylesheet
  ...
  <xsl:template match="/iana:registry">
    ...
    <body>
      ...
      <xsl:if
        test="iana:created|iana:updated|iana:description|iana:note|iana:xref|iana:record">
        <dl>
      ...
      <xsl:if test = "iana:file"><xsl:call-template name="iana:files" /></xsl:if>
      <xsl:apply-templates select="iana:registry" />
  ...
  <xsl:template match="iana:registry">
    <xsl:apply-templates select="iana:title"/>
    <xsl:if
      test="iana:registration_rule|iana:description|iana:note|iana:xref|iana:record">
      <dl>
        <xsl:apply-templates select="iana:registration_rule" />
        <xsl:apply-templates select="iana:description" />
        <xsl:call-template name="iana:references"/>
